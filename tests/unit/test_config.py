...
def test_load_env_vars_env(env_var_keys, env_vars_str, expected, monkeypatch):
    """
...
def test_load_env_vars_file(mock_isfile, env_var_keys, env_json_contents, expected, monkeypatch):
    """
...
def test_main(mock_load_env_vars, mock_open, args, expected):
